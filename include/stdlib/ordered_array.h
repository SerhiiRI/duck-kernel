...
ordered_array_t create_ordered_array(u32 max_size, lessthan_predicate_t less_then);

ordered_array_t place_ordered_array(void * addr, u32 max_size, lessthan_predicate_t less_then);
